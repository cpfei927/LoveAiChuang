...
import com.aic.loveaichuang.activity.ZxingActivity;
import com.aic.loveaichuang.adapter.HomeListViewAdapter;
import com.aic.loveaichuang.chat.ChatActivity;
...
public class HomeFragment extends Fragment implements OnPageChangeListener {
	...
	private void findViews() {
		...
		mView.findViewById(R.id.zxingBtn).setOnClickListener(new OnClickListener() {
		...
		mView.findViewById(R.id.chatActivityBtn).setOnClickListener(new OnClickListener() {
